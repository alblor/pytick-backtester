...
def run_single_strategy_backtest(data_path: str) -> None:
    ...
    Args:
        data_path: Path to Dukascopy data
    """
...
def main():
    ...
    # Set data path (adjust this to your Dukascopy data location)
    data_path = "/path/to/your/dukascopy/data"
    
    # Check if data path exists
    if not Path(data_path).exists():
        logger.error(f"Data path does not exist: {data_path}")
        logger.info("Please update the data_path variable to point to your Dukascopy data directory")
        return
